...
class Formats:
    class _Detail(Format):
        ...
        def build(self, app_id: str, lang: str, country: str) -> str:
            return self.URL_FORMAT.format(app_id=app_id, lang=lang,
                                          country=country)
        ...
        def build_body(
            ...
            if pagination_token is not None:
                ...
                result = self.PAYLOAD_FORMAT_FOR_FIRST_PAGE.format(
                    app_id=app_id, sort=sort, score=filter_score_with,
                    count=count
                )
    ...
    class _Searchresults(Format):
        ...
        def build(self, query: str, lang: str, country: str) -> str:
            return self.URL_FORMAT.format(query=query, lang=lang,
                                          country=country)
...
detail = Formats.Detail
reviews = Formats.Reviews
permissions = Formats.Permissions
search_results = Formats.SearchResults